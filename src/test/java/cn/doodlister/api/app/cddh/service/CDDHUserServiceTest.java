...
/*
    ...
    void getCode() {
        try {
            CDDHResult code = CDDHService.getCode("18830292635");
    ...
    void login(){
        try {
            CDDHUser user = CDDHService.login("15694310744", "2817");
    ...
    void bindInviteCode(){
        try {
            CDDHService.bindInviteCode("2440870","1.10016494.1037476.HUm.96cd67309c410d2f8a2e23daefd8b645");
